...
function copyHtml() {
    ...
    htmlStr = htmlStr.replace(
        'hyz.register_decripted_downloader(tmp_encriptSign,tmp_encriptKey,tmp_needMixFilename,tmp_nameMixSign);',
        `hyz.register_decripted_downloader('${encriptSign}','${encriptKey}',${needMixFilename},'${nameMixSign}');`
    )
...
module.exports = function applyWeChatGame({
    _buildFloderPath,
    _encriptSign,
    _encriptKey,
    _needMixFilename,
